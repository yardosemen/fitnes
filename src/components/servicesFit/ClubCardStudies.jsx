						...
						<Grid xs={12} md={6}>
							<Box>
								<span>
									...
									разновидностей оборудования. Тренажерный зал оборудован
									гантельным рядом (от 1 до 40 кг), множеством силовых
									тренажеров и набором штанг. <br />
								...
								<button style={buttonClubCard}>
									{" "}
									Расчитать стоимость карты
								</button>
							</Box>
						</Grid>
					</Grid>
...
export default ClubCardStudies;
